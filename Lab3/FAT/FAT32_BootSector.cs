...
namespace fat.FAT
{
    ...
    public struct FAT32_BootSector
    {
        ...
        public byte[] BPB_FATSz32;
        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] BPB_ExtFlags;
        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] BPB_FSVer;
        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] BPB_RootClus;

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] BPB_FSInfo;
        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] BPB_BkBootSec;
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        public byte[] BS_VolID;
        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 11)]
        public byte[] BS_VolLab;
        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
        public byte[] BS_FilSysType;
        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 420)]
        public byte[] BS_Empty;
        
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
        public byte[] BS_510_511_bytes;
