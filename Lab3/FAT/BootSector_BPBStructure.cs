...
namespace fat.FAT
{
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 1)]
        public struct BootSector_BPBStructure
        {
            ...
            public byte[] BPB_BytsPerSec;
 
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
            public byte[] BPB_SecPerClus;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] BPB_RsvdSecCnt;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
            public byte[] BPB_NumFATs;
 
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] BPB_RootEntCnt;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] BPB_TotSec16;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
            public byte[] BPB_Media;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] BPB_FATSz16;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] BPB_SecPerTrk;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] BPB_NumHeads;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] BPB_HiddSec;
            
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] BPB_TotSec32;

            public BootSector_BPBStructure(FatType fatType, short BytsPerSec)
              {
                  BS_jmpBoot = new byte[]{0xEB, 0x3C, 0x90};
                  BS_OEMName = Encoding.ASCII.GetBytes("MSWIN4.1");
                  BPB_BytsPerSec = BitConverter.GetBytes((short) BytsPerSec);
